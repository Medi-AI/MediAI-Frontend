const Symptoms = [
	...
	},
	{
		name: "skin_rash",
		description:
			"A change of the skin which affects its appearance or texture",
	...
	},
	{
		name: "joint_pain",
		description:
			"A discomfort or soreness in any of the joints of the body",
		synonyms: [
			"arthralgia",
			"joint stiffness",
			"joint inflammation",
	...
	},
	{
		name: "weight_loss",
		description:
			"Unintentional or significant reduction in body weight",
		synonyms: [
			"High blood sugar",
			"Low blood sugar",
			"Hyperglycemia",
	...
	},
	{
		...
		description:
			"Sore throat, pharyngitis, inflammation in the throat",
		synonyms: [
			"throat inflammation",
			"pharynx soreness",
			"painful throat",
	...
	},
	{
		...
		description:
			"Blood sugar fluctuations, unstable glucose levels.",
		synonyms: [
	...
	},
	{
		name: "cough",
		description:
			"Respiratory distress, hacking, throat irritation.",
		synonyms: [
			"persistent cough",
			"throat irritation",
			"bronchial cough",
	...
	},
	{
		name: "high_fever",
		description:
			"Elevated body temperature, feverishness, hyperthermia.",
		synonyms: [
			"severe fever",
			"high temperature",
			"feverish state",
	...
	},
	{
		name: "sunken_eyes",
		description:
			" Hollowed eyes, eye sockets appear deep, dehydration sign.",
		synonyms: [
			"hollowed-out eyes",
			"deep-set eyes",
			"sunken sockets",
	...
	},
	{
		name: "sweating",
		description:
			"Perspiration, sweating profusely, excessive sweating.",
		synonyms: [
			"heavy perspiration",
			"sweating profusely",
			"sweating buckets",
	...
	},
	{
		name: "dehydration",
		description:
			" Excessive fluid loss, lack of hydration, severe thirst.",
		synonyms: [
			"extreme thirst",
			"severe dehydration",
			"fluid depletion",
	...
	},
	{
		name: "headache",
		description:
			"Cephalalgia, head pain, pounding sensation in the head.",
		synonyms: [
			"throbbing head",
			"cephalalgia",
			"head discomfort",
	...
	},
	{
		name: "yellowish_skin",
		description:
			"Jaundice, skin discoloration, yellow tint on the skin.",
		synonyms: [
			"yellowed skin",
			"jaundiced skin",
			"skin discoloration",
	...
	},
	{
		name: "dark_urine",
		description:
			" Smelly urine, concentrated urine, decreased urine output.",
		synonyms: [
			"strong urine odor",
			"concentrated urine",
	...
	},
	{
		...
		description:
			"Eye pain, ocular discomfort, headache in the eye region.",
		synonyms: [
			"eye strain",
			"ocular ache",
	...
	},
	{
		name: "back_pain",
		description:
			" Spinal pain, lower backache, pain in the lumbar region.",
		synonyms: [
			"lumbago",
			"backache",
			"spine discomfort",
	...
	},
	{
		...
		description:
			"A painful or uncomfortable sensation while urinating.",
		synonyms: [
			"dysuria",
			"painful urination",
			"urinary burning",
	...
	},
	{
		name: "muscle_pain",
		description:
			"Discomfort or pain experienced in the muscles of the body.",
		synonyms: [
			"myalgia",
			"muscle ache",
			"sore muscles",
	...
	},
	{
		...
		description:
			"A person's past record of consuming alcoholic beverages.",
		synonyms: [
			"alcohol use history",
			"drinking habits",
			"past alcohol intake",
	...
	},
	{
		...
		description:
			"Red, inflamed bumps on the skin that are filled with pus.",
	...
	},
	{
		...
		description:
			"Nails that are inflamed and may be painful or discolored.",
		synonyms: [
			"swollen nails",
	...
	},
	{
		...
		description:
			"A painful, reddened lesion that develops around the nose.",
		synonyms: [
			"nasal sore",
			"nose soreness",
