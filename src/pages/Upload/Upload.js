	...
	return (
		<div className='medical-records-upload'>
			...
			<div className='right-side'>
				...
				<p>
					This in-house feature allows you to
					upload all your medical records
					(including previous reports and test
					results) onto the platform. Uploading
					your medical records offers better
					organization, improved safety and easy
					sharing with healthcare providers or
					insurance companies. It facilitates
					medical information management, prevents
					errors, and helps you receive the best
					possible care.
				</p>
				<br />
				{loading ? (
